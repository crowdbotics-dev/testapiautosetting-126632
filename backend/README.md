...
## Project Structure
    ...
    ├── testapiautosetting_126632  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126632`
...
2. Clone this repo and `cd testapiautosetting_126632`
